...
function Explore() {
  ...
  return (
    <div className='relative w-full min-h-screen text-white bg-linear-to-b from-[#0a0515] via-[#13052b] to-[#0a0515] overflow-hidden'>
      {/* glowing background */}
      ...
      {/* Scrollable area */}
      <div className='relative w-full h-screen overflow-y-auto px-4 sm:px-6 md:px-10 py-10'>
        ...
        <div className='grid gap-5 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 pb-10'>
          {MusicData.map((item) => (
